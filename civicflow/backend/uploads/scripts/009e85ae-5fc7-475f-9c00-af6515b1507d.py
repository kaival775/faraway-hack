...
def main():
    with sync_playwright() as p:
        ...
        # Date of birth (use fill as it's a date picker)
        safe_fill(page, "#dateOfBirthInput", "Unnamed Field", "10 Jan 1990", use_press=False)
        ...
        safe_fill(page, "#currentAddress", "Current Address", "123 Main Street, Springfield", use_press=False)
