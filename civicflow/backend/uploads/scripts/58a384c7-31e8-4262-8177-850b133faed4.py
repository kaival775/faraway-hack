    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            try:
                ...
                await file_input.set_input_files("C:\\Users\\khatr\\Downloads\\faraway-hack-main\\faraway-hack-main\\civicflow\\backend\\uploads\\user_docs\\3b8c9c44-2e17-4fd5-bcf0-89ef5d264a3e\\other\\20260614T163557__picture.png")
            ...
            try:
                await page.locator("#currentAddress").fill("tfygbjjj, yfuyg")
                await asyncio.sleep(0.3)
            except Exception as e:
            ...
            if captcha_info['present']:
                ...
                while True:
                    signal = await check_resume_signal("58a384c7-31e8-4262-8177-850b133faed4")
