    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            try:
                ...
                await file_input.set_input_files("C:\\Users\\khatr\\Downloads\\faraway-hack-main\\faraway-hack-main\\civicflow\\backend\\uploads\\user_docs\\3b8c9c44-2e17-4fd5-bcf0-89ef5d264a3e\\identity\\20260614T194015__aadhar.jpg")
            ...
            if captcha_info['present']:
                ...
                while True:
                    signal = await check_resume_signal("fcb7130e-ba75-42a1-8868-1d9fbc2e4fc6")
